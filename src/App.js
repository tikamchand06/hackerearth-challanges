        ...
        {filteredChallanges.map((challange, key) => (
          <Card
            ...
            actions={[
              ...
              <Button href={challange.subscribe} target="_blank" icon={<SendOutlined />} type="primary" shape="round">
                Subscribe
              </Button>,
            ]}
          >
    ...
    <Layout>
      <Header className="flex-item">
        ...
        <div>
          ...
          />
          <Tooltip title="Close">
            <Button shape="circle" icon={<CloseOutlined />} onClick={() => window.close()} className="ml-1" />
          </Tooltip>
        </div>
      </Header>
